...
SimpleCommand.prototype.initialize= SimpleCommand;
...
MacroCommand.prototype.initialize= MacroCommand;
...
{
    this.mediatorName= mediatorName || this.initialize.NAME;
...
Mediator.prototype.initialize= Mediator;
...
{
    this.proxyName= proxyName || this.initialize.NAME;
    if(data != null)
    {
        this.setData(data);
    }
...
Proxy.prototype.initialize= Proxy;
...
Facade.prototype.initialize= Facade;
...
,   extend: function (child, parent)
    {
        ...
        return child.prototype.initialize= child;
    }
 ...
 *             {
 *                  puremvc.Mediator.call(this, this.initialize.NAME, component);  
 *             }
 *         }
 *         
...
function define (classInfo, traits, staticTraits)
{
    ...
    {
        classConstructor= classInfo.initialize
    ...
    if (traits)
    {
        ...
        prototype.initialize= classConstructor;
    }
